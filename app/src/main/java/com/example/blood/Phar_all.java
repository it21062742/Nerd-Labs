...
public class Phar_all extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fetchRecords();
        custAdapter = new AdapterFor_Phar(this,getApplicationContext(),  id, name, email, contact, address);
        recyclerView.setAdapter(custAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(Phar_all.this));
    }

    void fetchRecords() {
        Pharmacy_request dh = new Pharmacy_request(Phar_all.this, Pharmacy_request.TABLENAME, null, 1);
        Cursor cursor = dh.allPharList();
